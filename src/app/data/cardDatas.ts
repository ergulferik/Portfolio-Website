...
const cardsTR: ProjectCard[] = [
  ...
  {
    "title": "Web Bağlantısı Güvenliği Testi",
  ...
  },
  {
    ...
    "extras": ["C#", ".NET Core", "WebSocket", "TCP/IP"],
    "id": "project5",
  ...
  },
  {
    ...
    "extras": ["Translation", "Web Application"],
    "id": "project6",
...
const experienceDataTR: ExperienceCards[] = [
  ...
  },
  {
    ...
    "extras": ["Web Architecture", "Research", "Teamwork"],
    "id": "experience3",
    "continueUrl": "http://www.ithinka.com.tr",
    "order": "3",
    "startTime": "07.2023",
    "endTime": "09.2023",
    "position": "Yazılım Geliştirici Stajyeri"
